...
public class BootStrapUser extends BaseFile implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Role rolePrivileges = createRolePrivileges("ROLE_ADMINISTRATOR", Arrays.asList("CREATE_USER", "UPDATE_USER", "DELETE_USER", "READ_USERS",
                "CREATE_BOOK", "READ_BOOKS", "UPDATE_BOOK", "DELETE_BOOK"));
